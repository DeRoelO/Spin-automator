...
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "gxt_span_results")
...
def run():
    log("=========================================================================")
    log("===   EXACT GXT SPAN CLICK: BESTAND -> NIEUWE MAATREGEL -> REGULIER   ===")
    log("=========================================================================")
    with sync_playwright() as p:
        ...
        # Click exact span element text 'Regulier'
        log("5. Klikken op 'span' element met tekst 'Regulier'...")
        span = page.locator("span", has_text="Regulier").first
        if span.is_visible():
            span.click(force=True)
            log("   Span 'Regulier' geklikt!")
            ...
            log("   Span 'Regulier' niet zichtbaar.")
