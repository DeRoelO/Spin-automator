...
SHOULDER_URL = "https://spin.rijkswaterstaat.nl/spin/?winId=GE_MEASURE_WINDOW_NEW&viewType=GE_MEASURE_WINDOW&measureId=-1&phaseId=0&eventId=0&isCopy=false&isInverse=false&mode=CREATE&version=-1&measureType=SHOULDER"
...
def run():
    log("=== TESTING NATIVE VLUCHTSTROOK/BERM FORM (measureId=-1 & measureType=SHOULDER) ===")
    with sync_playwright() as p:
        ...
        log("3. Vluchtstrook/berm formulier openen via GXT SPA URL (measureType=SHOULDER)...")
        ...
        for idx, w in enumerate(wins):
            if w.is_visible():
                ...
                log("5. Vluchtstrook/berm formulier invullen...")
                page.evaluate("""() => {
