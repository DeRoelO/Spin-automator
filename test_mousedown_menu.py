...
def run():
    log("=== TESTING MOUSEDOWN DISPATCH ON GXT MENU ITEM FOR VLUCHTSTROOK/BERM ===")
    with sync_playwright() as p:
        ...
        # Dispatch mousedown event directly on Vluchtstrook/berm anchor or div
        log("3. Mousedown + mouseup dispatchen op Vluchtstrook/berm...")
        page.evaluate("""() => {
            const els = Array.from(document.querySelectorAll('.x-menu a, .x-menu-list-item'));
